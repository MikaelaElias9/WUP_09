...
The best model using 2 regressors is height and width. 
...
For Pike the best model is all the variables

### Best Two regressor model
        
The best 2 regressor models would be length 1 and length 3
...
For Roach the best model is all the variables
        
### Best Two regressor model
         
The best model using 2 regressors is Length3 and Width. 
